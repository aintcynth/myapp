...
<body class="bg-gray-100 min-h-screen">
    <nav class="bg-red-600 text-white px-6 py-4 shadow">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold">Admin Dashboard</h1>
            <div>
                <span class="mr-4">Welcome, {{ auth()->user()->name }}</span>
                <a href="{{ route('logout') }}" class="bg-red-700 px-4 py-2 rounded hover:bg-red-800">Logout</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container mx-auto p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-600">Full system administration access</p>
            </div>
        </div>
    </div>
</body>
