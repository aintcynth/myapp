...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('staff.dashboard') }}">
            ...
            <div class="sidebar-brand-text mx-3">Staff <sup>Portal</sup></div>
        </a>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card shadow h-100">
                            <div class="card-header font-weight-bold text-primary">Tasks</div>
                            <div class="card-body">
                                <ul class="mb-0">
                                    <li><a href="{{ route('admin.admissions.index') }}">Review Admissions Assigned to You</a></li>
                                    <li class="text-gray-600">Only staff-assigned applications appear here.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
